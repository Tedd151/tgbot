...
greeting = [hi, hel, sup,hru, pop, rada, wag]
fg = random.choice(greeting)
...
emoji = [em1, em2, em3, em5, em4]
fe = random.choice(emoji)
...
def intro(message):
  ...
  bot.send_message(message.chat.id, fe)
  bot.send_message(message.chat.id, fg + " o " + username)
